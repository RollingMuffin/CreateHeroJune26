...
public class PsychologicalDescription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_psychological_description);

        //START MySQL code
        listView = (ListView)findViewById(R.id.listView60ImagesPsycho);
        adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1);
        listView.setAdapter(adapter);
        new ConnectionPsycho().execute();
        //END MySQL code
    }

    //Start MySQL code

    class ConnectionPsycho extends AsyncTask<String, String, String>{
        @Override
    ...
    public void onBackClick(View view)
    {
        if(view.getId() == R.id.btnBack){
            Intent i = new Intent(PsychologicalDescription.this, SelectMainFeatures02.class);
            startActivity(i);
        }
    }
    ...
    public void onNewPatternClick(View view)
    {
        if(view.getId() == R.id.btnNewPattern){
            Intent i = new Intent(PsychologicalDescription.this, PsychologicalDescription.class); // create new SELECT
            startActivity(i);
        }
    }
    ...
    public void onSaveWebPageClick(View view)
    {
        if(view.getId() == R.id.btnSaveWebPage){
            Intent i = new Intent(PsychologicalDescription.this, WebProject.class); // create new SELECT
            startActivity(i);
        }
    }
    ...
    public void onBuyPortrayalClick(View view)
    {
        if(view.getId() == R.id.btnBuyPortRayal){
            Intent i = new Intent(PsychologicalDescription.this, Cart.class);
            startActivity(i);
        }
    }
