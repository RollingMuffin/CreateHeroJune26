...
public class SelectAllMainFeatures extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_all_main_features);

        //START MySQL code
        listView = (ListView)findViewById(R.id.listView60ImagesAll);
        adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1);
        listView.setAdapter(adapter);
        new ConnectionAll().execute();
        //END MySQL code
    }

    //Start MySQL code

    class ConnectionAll extends AsyncTask<String, String, String>{
        @Override
    ...
    public void onBackClick(View view)
    {
        if(view.getId() == R.id.btnBack){
            //Intent i = new Intent(SelectAllMainFeatures.this, SelectAllMainFeatures.class);
            Intent i = new Intent(SelectAllMainFeatures.this, PhotoCatalog.class);
            startActivity(i);
        }
    }
    ...
    public void onNewPatternClick(View view)
    {
        if(view.getId() == R.id.btnNewPattern){
            Intent i = new Intent(SelectAllMainFeatures.this, Values.class); // create new SELECT
            startActivity(i);
        }
    }
    ...
    public void onSaveWebPageClick(View view)
    {
        if(view.getId() == R.id.btnSaveWebPage){
            Intent i = new Intent(SelectAllMainFeatures.this, WebProject.class); // create new SELECT
            startActivity(i);
        }
    }
    ...
    public void onBuyPortrayalClick(View view)
    {
        if(view.getId() == R.id.btnBuyPortRayal){
            Intent i = new Intent(SelectAllMainFeatures.this, Cart.class);
            startActivity(i);
        }
    }
