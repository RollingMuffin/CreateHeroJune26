...
public class Goals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //START MySQL code
        listView = (ListView)findViewById(R.id.listView60ImagesGoals);
        adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1);
        listView.setAdapter(adapter);
        new ConnectionGoals().execute();
        //END MySQL code
}

    //Start MySQL code

    class ConnectionGoals extends AsyncTask<String, String, String>{
        @Override
    ...
    public void onBackClick(View view)
    {
        if(view.getId() == R.id.btnBack){
            Intent i = new Intent(Goals.this, SelectMainFeatures02.class);
            startActivity(i);
        }
    }
    ...
    public void onNewPatternClick(View view)
    {
        if(view.getId() == R.id.btnNewPattern){
            Intent i = new Intent(Goals.this, Goals.class); // create new SELECT
            startActivity(i);
        }
    }
    ...
    public void onSaveWebPageClick(View view)
    {
        if(view.getId() == R.id.btnSaveWebPage){
            Intent i = new Intent(Goals.this, WebProject.class); // create new SELECT
            startActivity(i);
        }
    }
    ...
    public void onBuyPortrayalClick(View view)
    {
        if(view.getId() == R.id.btnBuyPortRayal){
            Intent i = new Intent(Goals.this, Cart.class);
            startActivity(i);
        }
    }
