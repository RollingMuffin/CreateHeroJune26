...
public class Values extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //START MySQL code
        listView = (ListView)findViewById(R.id.listView60ImagesValues);
        adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1);
        listView.setAdapter(adapter);
        new ConnectionValues().execute();
        //END MySQL code
    }

    //Start MySQL code

    class ConnectionValues extends AsyncTask<String, String, String>{
        @Override
    ...
    public void onBackClick(View view)
    {
        if(view.getId() == R.id.btnBack){
            Intent i = new Intent(Values.this, ListdataActivity.class);
            startActivity(i);
        }
    }
    ...
    public void onNewPatternClick(View view)
    {
        if(view.getId() == R.id.btnNewPattern){
            Intent i = new Intent(Values.this, Values.class); // create new SELECT
            startActivity(i);
        }
    }
    ...
    public void onSaveWebPageClick(View view)
    {
        if(view.getId() == R.id.btnSaveWebPage){
            Intent i = new Intent(Values.this, WebProject.class); // create new SELECT
            startActivity(i);
        }
    }
    ...
    public void onBuyPortrayalClick(View view)
    {
        if(view.getId() == R.id.btnBuyPortRayal){
            Intent i = new Intent(Values.this, Cart.class);
            startActivity(i);
        }
    }
